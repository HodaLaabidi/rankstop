...
public class EvalCriteriasAdapter extends RecyclerView.Adapter<EvalCriteriasAdapter.ViewHolder> {
    ...
    private List<Criteria> listCriteria = new ArrayList<>();

    public EvalCriteriasAdapter(List<Criteria> listCriteria, CriteriaEvalListener noteListener, Context context) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(Criteria criteria) {
            signSeekBar.getConfigBuilder()
                    ...
                    .build();
            criteriaNameTV.setText(criteria.getName());
        }
    }
}
