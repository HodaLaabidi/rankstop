...
public class ItemCreatedFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_item_created, container, false);
        return rootView;
    }
    ...
    private static ItemCreatedFragment instance;

    public static ItemCreatedFragment getInstance() {
        if (instance == null) {
            instance = new ItemCreatedFragment();
        }
        return instance;
    }
