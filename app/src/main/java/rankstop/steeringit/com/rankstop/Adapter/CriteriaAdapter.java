...
package rankstop.steeringit.com.rankstop.Adapter;
...
public class CriteriaAdapter extends RecyclerView.Adapter<CriteriaAdapter.ViewHolder> {
    ...
    public CriteriaAdapter(List<Criteria> criterias, RecyclerViewClickListener listener, Context context) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private BarData generateBarData(Criteria criteria) {
