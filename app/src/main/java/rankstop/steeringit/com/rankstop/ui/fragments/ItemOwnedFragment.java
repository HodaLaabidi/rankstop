...
public class ItemOwnedFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_item_owned, container, false);
        return rootView;
    }
    ...
    private static ItemOwnedFragment instance;

    public static ItemOwnedFragment getInstance() {
        if (instance == null) {
            instance = new ItemOwnedFragment();
        }
        return instance;
    }
